...
import { AppRegistry, StyleSheet, Text, View, Platform, TouchableHighlight, Button, ScrollView } from 'react-native';
...
export default class Example extends Component {
  ...
  componentDidMount() {
    ...
    AdMobRewarded.addEventListener('rewardedVideoDidStartPlaying', () => console.log('rewardedVideoDidStartPlaying'));
    ...
    AdMobInterstitial.addEventListener('interstitialDidFailToLoad', error =>
      console.log('interstitialDidFailToLoad', error)
    );
      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          <BannerExample title="DFP - App Events" style={this.state.appEventsExampleStyle}>
            ...
            />
            <Button title="Reload" onPress={() => this._appEventsExample.loadBanner()} style={styles.button} />
          </BannerExample>
          <BannerExample title="DFP - Fluid Ad Size">
            <View style={[{ backgroundColor: '#f3f', paddingVertical: 10 }, this.state.fluidAdSizeExampleStyle]}>
              <PublisherBanner
                adSize="fluid"
            ...
            <Button
              ...
              style={styles.button}
            />
            <Button title="Reload" onPress={() => this._appFluidAdSizeExample.loadBanner()} style={styles.button} />
          </BannerExample>
        </ScrollView>
      </View>
    );
